function scope_html(){
    ...
    if(!isMobileDevice()){
        ...
        cells_permitRequired_label[0].style.width = '115px';
    ...
    function radio_input_html(table, question, name, identifier, tab = 0){
